...
if __name__ == "__main__":
    input_folder = Path("/Users/ateeb.taseer/projects/arbiosft_products/arbi-tryon/in_im")
    output_folder = Path("/Users/ateeb.taseer/projects/arbiosft_products/arbi-tryon/output")
